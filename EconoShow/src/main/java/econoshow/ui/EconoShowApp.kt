 ...
 *
 * This is used in the [NavHost] to control what is our currentScreen.
 *
 * @property title The String Resource used in the app top bar to identify the screen
 * @see EconoShowApp
 * @see EconoShowAppBar
 */
 ...
 *
 * @param canNavigateBack Used to determine if the user can navigate backwards and to display the back button
 * @param navigateUp Function that is invoked when the back button is pressed
 * @param currentScreen Used to display the name of the current screen
 ...
 *
 * @param windowSize Used to determine the general layout of the based on the device's size
 * @param navController Sets up a [NavHostController] so that the [NavHost] can function. Does not need to be set.
 * @param modifier The [Modifier] to be applied to this component.
 */
@Composable
fun EconoShowApp(
